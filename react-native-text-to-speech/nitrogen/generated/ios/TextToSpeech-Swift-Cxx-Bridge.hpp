///
/// TextToSpeech-Swift-Cxx-Bridge.hpp
...
namespace margelo::nitro::texttospeech::bridge::swift {
  ...
  /**
   * Specialized version of `std::shared_ptr<margelo::nitro::texttospeech::HybridTextToSpeechSpec>`.
   */
  using std__shared_ptr_margelo__nitro__texttospeech__HybridTextToSpeechSpec_ = std::shared_ptr<margelo::nitro::texttospeech::HybridTextToSpeechSpec>;
  ...
  // pragma MARK: std::weak_ptr<margelo::nitro::texttospeech::HybridTextToSpeechSpec>
  using std__weak_ptr_margelo__nitro__texttospeech__HybridTextToSpeechSpec_ = std::weak_ptr<margelo::nitro::texttospeech::HybridTextToSpeechSpec>;
  inline std__weak_ptr_margelo__nitro__texttospeech__HybridTextToSpeechSpec_ weakify_std__shared_ptr_margelo__nitro__texttospeech__HybridTextToSpeechSpec_(const std::shared_ptr<margelo::nitro::texttospeech::HybridTextToSpeechSpec>& strong) { return strong; }
