...
public class HybridTextToSpeechSpec_cxx {
  ...
  @inline(__always)
  public func addListener(event: Int32, listener: bridge.Func_void_std__optional_std__string_) -> bridge.Result_std__function_void____ {
    do {
      let __result = try self.__implementation.addListener(event: margelo.nitro.nitrotexttospeech.EventName(rawValue: event)!, listener: { () -> (String?) -> Void in
