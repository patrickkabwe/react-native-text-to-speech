...
/**
 * Represents the JavaScript callback `(word: optional) => void`.
...
class Func_void_std__optional_std__string_ {
  @DoNotStrip
  @Keep
   ...
   */
  fun toLambda(): (word: String?) -> Unit = this::call
   ...
   */
  @FastNative
  external fun call(word: String?): Unit
}
